...
Pre-condición: el design debe estar aprobado por el humano — su header debe traer el sello `> Aprobado por ...`. Si no lo trae, detente y pídelo.
...
Al terminar, recuerda al humano que tasks.md requiere su aprobación antes de pasar a la fase 6 (build). Al recibirla, estampa el sello bajo el título del documento: `> Aprobado por [nombre] — YYYY-MM-DD`. Sin sello, el documento no cuenta como aprobado.
